...
public class SwingUtils {
    ...
    public static void drawShadowText(Graphics2D g2, String s, int x, int y) {
        drawShadowText(g2, s, x, y, new Color(255, 255, 255), 1);
    }
    ...
    public static void drawCenteredShadowText(Graphics2D g2, String s, int x, int y) {
        drawCenteredShadowText(g2, s, x, y, new Color(255, 255, 255));
    }
     ...
     * <p/>
     * This code is adapted from java.awt.Color to take in a factor. Therefore,
     * it inherits its quirks. Most importantly, a smaller factor makes the
     * color more bright.
     *
     * @param c a color
